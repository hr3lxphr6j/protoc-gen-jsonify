...
const defaultJSONPbLib = "github.com/golang/protobuf/jsonpb"

// JSONifyModule adds encoding/json Marshaler and Unmarshaler methods on PB
...
func (p *JSONifyModule) jsonPbLibName() string {
	return p.ctx.Params().StrDefault("jsonpb", defaultJSONPbLib)
}

const jsonifyTpl = `// Code generated by protoc-gen-jsonify. DO NOT EDIT.
// source: {{ .InputPath }}
